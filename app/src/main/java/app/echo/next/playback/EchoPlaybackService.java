...
public final class EchoPlaybackService extends MediaSessionService {
    public static final String ACTION_PLAY = "app.echo.next.action.PLAY";
    public static final String ACTION_PAUSE = "app.echo.next.action.PAUSE";
    ...
    private void createNotificationChannel() {
        ...
        channel.setDescription("ECHO NEXT 播放控制");
