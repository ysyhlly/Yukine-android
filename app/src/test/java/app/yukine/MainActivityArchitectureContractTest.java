...
public final class MainActivityArchitectureContractTest {
    ...
    public void playbackQueueMutationKeepsOneClearlyNamedEntryPointCluster() throws Exception {
        ...
        assertTrue(mirroredTransitionOwner.contains("boolean queueEmpty = queueStateSnapshot().isQueueEmpty();"));
    ...
    public void playbackCrossfadeCommandsAreOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(stateOwner.contains("private final Supplier<PlaybackQueueManager> playbackQueueManagerSupplier;"));
    ...
    public void playbackServiceActionMappingIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(favoriteCommandOwner.contains("private static Track currentTrack(PlaybackQueueManager playbackQueueManager)"));
        assertTrue(favoriteCommandOwner.contains("playbackQueueManager.queueStateSnapshot().getCurrentTrack()"));
