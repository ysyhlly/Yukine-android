...
public final class MainActivityArchitectureContractTest {
    ...
    public void playbackStartDefersHeavyVisualizationWork() throws Exception {
        ...
        assertTrue(stateSnapshotOwner.contains("PlaybackQueueManager.QueueStateSnapshot queueSnapshot = queueStateOwner == null"));
        assertTrue(stateSnapshotOwner.contains(": queueStateOwner.queueStateSnapshot();"));
        ...
        assertTrue(visualizationCacheStateOwner.contains("PlaybackQueueManager.QueueStateSnapshot snapshot = queueStateOwner == null"));
        assertTrue(visualizationCacheStateOwner.contains("PlaybackQueueManager.QueueStateSnapshot.empty()"));
        assertTrue(visualizationCacheStateOwner.contains(": queueStateOwner.queueStateSnapshot();"));
        assertTrue(visualizationCacheStateOwner.contains("return snapshot.getCurrentTrack();"));
    ...
    public void streamingPlaybackCacheUsesSegmentedConcurrentPrecache() throws Exception {
        ...
        assertTrue(playbackPrecacheStateOwner.contains("PlaybackQueueManager.QueueStateSnapshot snapshot = queueStateOwner == null"));
        assertTrue(playbackPrecacheStateOwner.contains(": queueStateOwner.queueStateSnapshot();"));
        assertTrue(playbackPrecacheStateOwner.contains("return snapshot.getCurrentTrack();"));
        assertFalse(playbackPrecacheStateOwner.contains(": queueStateOwner.currentTrack();"));
        assertFalse(playbackPrecacheStateOwner.contains("queueStateOwner.queueStateSnapshot().getCurrentTrack()"));
        assertFalse(playbackPrecacheStateOwner.contains("return currentTrackSupplier == null ? null : currentTrackSupplier.get();"));
        assertFalse(playbackPrecacheStateOwner.contains("queueStateOwner.upcomingTracksForPrecache(maxCount)"));
    ...
    public void playbackQueueMutationKeepsOneClearlyNamedEntryPointCluster() throws Exception {
        ...
        assertFalse(queueMutationOwner.contains("PlaybackQueueStateOwner queueStateOwner"));
    ...
    public void playbackRuntimeStateIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(owner.contains("queueManagerSupplier: Supplier<PlaybackQueueManager?>?"));
    ...
    public void playbackServiceActionMappingIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(favoriteCommandOwner.contains("PlaybackQueueManager.QueueStateSnapshot snapshot = queueStateOwner == null"));
        assertTrue(favoriteCommandOwner.contains(": queueStateOwner.queueStateSnapshot();"));
        assertTrue(favoriteCommandOwner.contains("Track track = snapshot.getCurrentTrack();"));
