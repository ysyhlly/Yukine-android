...
public final class MainActivityArchitectureContractTest {
    ...
    public void playbackServiceActionMappingIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertFalse(activeStateOwner.contains("interface CurrentTrackProvider"));
        assertFalse(activeStateOwner.contains("interface PlayingStateProvider"));
        assertFalse(activeStateOwner.contains("interface PreparingStateProvider"));
        assertTrue(activeStateOwner.contains("import java.util.function.BooleanSupplier;"));
        assertTrue(activeStateOwner.contains("import java.util.function.Supplier;"));
        assertTrue(activeStateOwner.contains("private final Supplier<Track> currentTrackProvider;"));
        assertTrue(activeStateOwner.contains("private final BooleanSupplier playingStateProvider;"));
        assertTrue(activeStateOwner.contains("private final BooleanSupplier preparingStateProvider;"));
        assertTrue(activeStateOwner.contains("return currentTrackProvider == null ? null : currentTrackProvider.get();"));
        assertTrue(activeStateOwner.contains("return playingStateProvider != null && playingStateProvider.getAsBoolean();"));
        assertTrue(activeStateOwner.contains("return preparingStateProvider != null && preparingStateProvider.getAsBoolean();"));
