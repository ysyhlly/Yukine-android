...
public final class MainActivityArchitectureContractTest {
    ...
    public void streamingPlaybackCacheUsesSegmentedConcurrentPrecache() throws Exception {
        ...
        assertTrue(playbackPrecacheStateOwner.contains(": queueStateOwner.currentTrack();"));
    ...
    public void playbackQueueMutationKeepsOneClearlyNamedEntryPointCluster() throws Exception {
        ...
        assertTrue(queueMutationOwner.contains("PlaybackQueueManager.QueueStateSnapshot queueSnapshot = queueStateOwner == null"));
        assertTrue(queueMutationOwner.contains(": queueStateOwner.queueStateSnapshot();"));
        assertTrue(queueMutationOwner.contains("if (!queueSnapshot.isQueueEmpty())"));
        ...
        assertFalse(queueStateOwner.contains("return queueStateSnapshot().isQueueEmpty();"));
        assertTrue(queueStateOwner.contains("PlaybackQueueManager.QueueStateSnapshot queueStateSnapshot()"));
        ...
        assertTrue(mirroredTransitionOwner.contains("return mirrorsQueue && !queueSnapshot.isQueueEmpty();"));
    ...
    public void playbackErrorRecoveryIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertFalse(queueStateOwner.contains("return queueStateSnapshot().isAtEndOfQueue();"));
    ...
    public void playbackErrorRecoveryCommandsAreOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertFalse(commandOwner.contains("private final PlaybackStateSnapshotOwner.QueueStateProvider queueStateProvider;"));
        assertTrue(commandOwner.contains("PlaybackQueueManager.QueueStateSnapshot queueSnapshot = queueStateOwner == null"));
        ...
        assertTrue(commandOwner.contains("return queueStateOwner == null ? null : queueStateOwner.currentTrack();"));
        assertFalse(commandOwner.contains("return queueStateSnapshot().getCurrentTrack();"));
        assertFalse(commandOwner.contains("&& queueStateOwner != null"));
        assertTrue(commandOwner.contains("&& queueSnapshot.getHasMultipleTracks();"));
    ...
    public void playbackCrossfadeCommandsAreOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(stateOwner.contains("PlaybackQueueManager.QueueStateSnapshot queueSnapshot = queueStateOwner == null"));
        assertTrue(stateOwner.contains(": queueStateOwner.queueStateSnapshot();"));
        assertTrue(stateOwner.contains("if (!queueSnapshot.getHasMultipleTracks())"));
        ...
        assertTrue(stateOwner.contains("return repeatModeProvider.getAsInt() != REPEAT_OFF || !queueSnapshot.isAtEndOfQueue();"));
    ...
    public void playbackServiceActionMappingIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(stateOwner.contains("PlaybackQueueManager.QueueStateSnapshot queueSnapshot = queueStateOwner == null"));
        assertTrue(stateOwner.contains(": queueStateOwner.queueStateSnapshot();"));
        assertTrue(stateOwner.contains("return queueSnapshot.isQueueEmpty();"));
