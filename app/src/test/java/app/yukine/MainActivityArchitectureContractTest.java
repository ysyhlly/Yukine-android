...
public final class MainActivityArchitectureContractTest {
    ...
    public void playbackStartDefersHeavyVisualizationWork() throws Exception {
        ...
        assertFalse(visualizationCacheStateOwner.contains("return queueStateSnapshot().getCurrentTrack();"));
    ...
    public void streamingPlaybackCacheUsesSegmentedConcurrentPrecache() throws Exception {
        ...
        assertTrue(playbackService.contains("PlaybackPrecacheStateOwner playbackPrecacheStateOwner = new PlaybackPrecacheStateOwner("));
        String normalizedPrecacheStateWiring = normalizedPlaybackService.substring(
                normalizedPlaybackService.indexOf(
    ...
    public void liveLyricsNotificationServiceKeepsOppoFluidCloudContract() throws Exception {
        ...
        assertTrue(lyricsStateOwner.contains("Supplier<Track> currentTrackSupplier"));
        assertTrue(lyricsStateOwner.contains("return currentTrackSupplier == null ? null : currentTrackSupplier.get();"));
    ...
    public void playbackQueuePersistenceIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertFalse(service.contains("playbackShutdownQueueLifecycleStoreOwner"));
        assertTrue(service.contains("playbackQueuePersistenceOwner.persistQueueState();"));
        ...
        assertTrue(service.contains("playbackQueuePersistenceOwner.savePlaybackResumeRequested("));
    ...
    public void playbackQueueMutationKeepsOneClearlyNamedEntryPointCluster() throws Exception {
        ...
        assertTrue(mirroredPlayerOwner.contains("private final Supplier<Track> currentTrackSupplier;"));
        assertTrue(mirroredPlayerOwner.contains("return currentTrackSupplier == null ? null : currentTrackSupplier.get();"));
        ...
        assertFalse(service.contains("return playbackQueueStateOwner.queueStateSnapshot().getCurrentTrack();"));
        ...
        assertTrue(mirroredTransitionOwner.contains("private final Supplier<PlaybackQueueManager> playbackQueueManagerSupplier;"));
        assertTrue(mirroredTransitionOwner.contains("private PlaybackQueueManager playbackQueueManager()"));
        assertTrue(mirroredTransitionOwner.contains("private final BooleanSupplier playerMirrorsQueue;"));
        assertFalse(mirroredTransitionOwner.contains("private final BooleanSupplier queueEmpty;"));
        ...
        assertTrue(mirroredTransitionOwner.contains("PlaybackQueueManager playbackQueueManager = playbackQueueManager();"));
        assertTrue(mirroredTransitionOwner.contains("return snapshot == null ? PlaybackQueueManager.QueueStateSnapshot.empty() : snapshot;"));
    ...
    public void playbackErrorRecoveryIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(errorRecoveryCommandWiring.contains("playbackQueueStateOwner::currentTrack"));
        assertTrue(errorRecoveryCommandWiring.contains("playbackQueueStateOwner::hasMultipleTracks"));
        ...
        assertTrue(queueStateOwner.contains("return queueStateSnapshot().getHasMultipleTracks();"));
    ...
    public void playbackServiceShutdownIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(queuePersistenceOwner.contains("private final Supplier<PlaybackQueueStore> queueStoreSupplier;"));
        assertTrue(queuePersistenceOwner.contains("private PlaybackQueueManager playbackQueueManager()"));
        assertTrue(queuePersistenceOwner.contains("private PlaybackQueueStore queueStore()"));
    ...
    public void playbackErrorRecoveryCommandsAreOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(errorRecoveryWiring.contains("playbackQueueStateOwner::currentTrack"));
        assertTrue(errorRecoveryWiring.contains("playbackQueueStateOwner::hasMultipleTracks"));
        ...
        assertFalse(commandOwner.contains("queueStateSnapshot()"));
        assertTrue(commandOwner.contains("private final Supplier<Track> currentTrackSupplier;"));
        assertTrue(commandOwner.contains("private final BooleanSupplier hasMultipleTracksSupplier;"));
        assertTrue(commandOwner.contains("return currentTrackSupplier == null ? null : currentTrackSupplier.get();"));
        assertTrue(commandOwner.contains("hasMultipleTracksSupplier.getAsBoolean()"));
        assertTrue(commandOwner.contains("private final Consumer<Boolean> playbackPreparer;"));
    ...
    public void playbackCrossfadeCommandsAreOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertFalse(service.contains(
                "                () -> playbackModeSettingsStore == null\n"
                        ...
                        + "                playbackQueueStateOwner,"));
        assertTrue(service.contains("                playbackQueueStateOwner::hasMultipleTracks,"));
        assertTrue(service.contains("                playbackQueueStateOwner::isAtEndOfQueue,"));
        ...
        assertTrue(stateOwner.contains("private final BooleanSupplier hasMultipleTracksProvider;"));
        assertTrue(stateOwner.contains("private final BooleanSupplier atEndOfQueueProvider;"));
        ...
        assertTrue(stateOwner.contains("if (hasMultipleTracksProvider == null || !hasMultipleTracksProvider.getAsBoolean())"));
        assertTrue(stateOwner.contains("boolean atEndOfQueue = atEndOfQueueProvider != null && atEndOfQueueProvider.getAsBoolean();"));
        assertTrue(stateOwner.contains("return repeatModeProvider.getAsInt() != REPEAT_OFF || !atEndOfQueue;"));
    ...
    public void playbackServiceActionMappingIsOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(stateOwner.contains("private final PlaybackStateSnapshotOwner.QueueStateProvider queueStateProvider;"));
