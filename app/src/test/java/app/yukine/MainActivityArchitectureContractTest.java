...
public final class MainActivityArchitectureContractTest {
    ...
    public void playbackQueueMutationKeepsOneClearlyNamedEntryPointCluster() throws Exception {
        ...
        assertTrue(mirroredPlayerOwner.contains("private final PlaybackStateSnapshotOwner.QueueStateProvider queueStateProvider;"));
        assertTrue(mirroredPlayerOwner.contains("PlaybackQueueManager.QueueStateSnapshot snapshot = queueStateProvider.queueStateSnapshot();"));
    ...
    public void playbackCrossfadeCommandsAreOwnedOutsideEchoPlaybackService() throws Exception {
        ...
        assertTrue(stateOwner.contains(": queueStateProvider.queueStateSnapshot();"));
        assertTrue(stateOwner.contains("if (!snapshot.getHasMultipleTracks())"));
        assertTrue(stateOwner.contains("return repeatModeProvider.getAsInt() != REPEAT_OFF || !snapshot.isAtEndOfQueue();"));
