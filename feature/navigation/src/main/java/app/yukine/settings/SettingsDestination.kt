...
fun SettingsDestination(
    ...
    SettingsScreen(
        ...
        issues = settingsState.destinationIssues,
        issuesTitle = settingsState.destinationIssuesTitle,
        searchEntries = settingsState.destinationSearchEntries,
        searchPlaceholder = settingsState.destinationSearchPlaceholder,
        searchResultsTitle = settingsState.destinationSearchResultsTitle,
        searchEmptyMessage = settingsState.destinationSearchEmptyMessage,
        highlightedEntryId = settingsState.destinationHighlightedEntryId,
