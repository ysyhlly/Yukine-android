...
enum class SettingsEntryId {
    ...
    IdentityRebuild,
    LibraryDedupSafe,
    LibraryDedupAggressive,
    DuplicateCandidateCenter,
...
object SettingsInformationArchitecture {
    ...
    private val entries: List<SettingsEntrySpec> = listOf(
        ...
        entryWithKeywords(SettingsEntryId.RefreshMusicFolders, SettingsCategoryId.LibraryMetadata, "music.folders.refresh.all", icon = EchoIconKind.Sync, keywords = arrayOf("rescan", "folder", "\u91cd\u626b", "\u6587\u4ef6\u5939")),
        entryWithKeywords(SettingsEntryId.RemoveMusicFolder, SettingsCategoryId.LibraryMetadata, "music.folders.remove", icon = EchoIconKind.Remove, keywords = arrayOf("remove", "folder", "\u79fb\u9664", "\u6587\u4ef6\u5939")),
        ...
        entryWithKeywords(SettingsEntryId.LibraryDedupSafe, SettingsCategoryId.LibraryMetadata, "library.dedup.safe", icon = EchoIconKind.Library, keywords = arrayOf("dedup", "duplicate", "\u53bb\u91cd", "\u91cd\u590d")),
        entryWithKeywords(SettingsEntryId.LibraryDedupAggressive, SettingsCategoryId.LibraryMetadata, "library.dedup.aggressive", icon = EchoIconKind.Library, keywords = arrayOf("aggressive", "dedup", "\u6700\u5927\u5316", "\u53bb\u91cd")),
        entryWithKeywords(SettingsEntryId.DuplicateCandidateCenter, SettingsCategoryId.LibraryMetadata, "library.dedup.candidates", icon = EchoIconKind.Library, keywords = arrayOf("candidate", "duplicate", "\u5019\u9009", "\u91cd\u590d")),
